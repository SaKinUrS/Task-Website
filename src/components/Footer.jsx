    ...
    <footer className="footer">
      <div className="footer__container">
        ...
        <div className="footer__contacts">
          <a href="#!" className="footer__tel tel">
            <svg
              className="tel__icon icon"
              width="14"
              height="14"
              viewBox="0 0 14 14"
              fill="none"
            ...
            <h5 className="tel__name name">+7 (495) 555-55-55</h5>
          </a>
          <a href="#!" className="footer__location">
            <svg
            ...
            <h5 className="location__name name">
